...
export default function LeftAlignedTimeline() {
  return (
    ...
    <Timeline
      ...
      <h1 className='ContentHeader'>All My Experiences</h1> <br/>
      <TimelineItem>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          <i>Trainee</i> <br />
          • Develop the ability to increase work efficiency by devloping programs for effective use of computers.<br /> <br />
        </TimelineContent>
      </TimelineItem>
